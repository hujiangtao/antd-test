...
import { OrderTableHeader, formList } from '../../config/constant';
import './order.less';
import { BaseFilterForm } from '../../components/base_form';
        ...
        return (
            <div>
                ...
                <div className="content-wrap">
                    <Table bordered columns={OrderTableHeader} dataSource={this.state.list} pagination={this.state.pagination}
                ...
                <Card>
                    <BaseFilterForm formList={formList} filterSubmit={this.handleFilter} />
                </Card>
            </div>
        );
    }
